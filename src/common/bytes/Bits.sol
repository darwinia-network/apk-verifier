...
/// @title Bits
/// @custom:inspired From https://github.com/ethereum/solidity-examples
library Bits {
    ...
    /// @dev Sets the bit at the given 'index' in 'self' to '0'.
    /// Returns the modified value.
    function clearBit(uint256 self, uint8 index) internal pure returns (uint256) {
        return self & ~(ONE << index);
    }

    /// @dev Sets the bit at the given 'index' in 'self' to:
    ///  '1' - if the bit is '0'
    ///  '0' - if the bit is '1'
    /// Returns the modified value.
    ...
    /// @dev Get the value of the bit at the given 'index' in 'self'.
    function bit(uint256 self, uint8 index) internal pure returns (uint8) {
        return uint8((self >> index) & 1);
    }

    /// @dev Check if the bit at the given 'index' in 'self' is set.
    /// Returns:
    ...
    /// @dev Checks if the bit at the given 'index' in 'self' is equal to the corresponding
    /// bit in 'other'.
    /// Returns:
    ...
    /// @dev Get the bitwise NOT of the bit at the given 'index' in 'self'.
    function bitNot(uint256 self, uint8 index) internal pure returns (uint8) {
        return uint8(1 - ((self >> index) & 1));
    }

    /// @dev Computes the bitwise AND of the bit at the given 'index' in 'self', and the
    /// corresponding bit in 'other', and returns the value.
    function bitAnd(uint256 self, uint256 other, uint8 index) internal pure returns (uint8) {
        return uint8(((self & other) >> index) & 1);
    }

    /// @dev Computes the bitwise OR of the bit at the given 'index' in 'self', and the
    /// corresponding bit in 'other', and returns the value.
    function bitOr(uint256 self, uint256 other, uint8 index) internal pure returns (uint8) {
        return uint8(((self | other) >> index) & 1);
    }

    /// @dev Computes the bitwise XOR of the bit at the given 'index' in 'self', and the
    /// corresponding bit in 'other', and returns the value.
    function bitXor(uint256 self, uint256 other, uint8 index) internal pure returns (uint8) {
        return uint8(((self ^ other) >> index) & 1);
    }

    /// @dev Gets 'numBits' consecutive bits from 'self', starting from the bit at 'startIndex'.
    ...
    /// @dev Computes the index of the highest bit set in 'self'.
    ...
    /// @dev Computes the index of the lowest bit set in 'self'.
